<!-- CreatedBy: Pravesh Dwivedi Solace
     ...
     purpose: to declare some function for calculator -->
<template>
  <section class="flex w-full">
    <div class="m-auto">
      <h1 class="text-2xl text-center">Calculator</h1>
      <p
        class="text-3xl text-right mt-10 w-32 h-12 overflow-x-scroll"
        style="direction: rtl"
      >
        {{ currentNum }}
      </p>
...
export default {
  setup() {
    ...
    // function to get value when press any button
    ...
    // function to perform maths operations
    ...
    // handle the key event for other pages
